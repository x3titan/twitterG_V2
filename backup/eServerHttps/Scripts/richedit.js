...
var richeditInitialized = false;
function richeditInit() {
    if (richeditInitialized) return;
    richeditInitialized = true; 
    addCSS(
        "body{ font-size:12px;} " +
        "#ed{ height:300px; width:800px; background-color:#fff } " +
        ".sssss{ background-image:url(res/richedit/20099493121.gif)} " +
        ".tag{ background-image:url(res/richedit/20099493121.gif);height:22px; display:inline-table;float:left; ;cursor: pointer; margin-top:8px; margin-left:5px; margin-right:2px; vertical-align:middle; line-height:20px;} " +
        ...
        ".ppt{ height:24px; width:100%; background-image:url(res/richedit/203207031.p.gif); font-size:12px; font-weight: bold; vertical-align:middle; line-height:24px; } "
    );
}
...
var Editer = new Class({
    options: {
        ...
        facebg: [{
            ...
            title: "微笑",
            wl: 22,
            src: "res/richedit/220846596.p.gif"
        }, {
            bgimg: "-31px -4px",
            title: "大笑",
            wl: 22,
            src: "res/richedit/220859814.p.gif"
        }, {
            bgimg: "-58px -4px",
            title: "窃笑",
            wl: 22,
            src: "res/richedit/220911971.p.gif"
        }, {
            bgimg: "-85px -4px",
            title: "眨眼",
            wl: 22,
            src: "res/richedit/220928549.p.gif"
        }, {
            bgimg: "-112px -4px",
            title: "鬼脸",
            wl: 22,
            ...
            title: "色色",
            wl: 22,
            src: "res/richedit/220951955.p.gif"
        }, {
            bgimg: "-167px -4px",
            title: "暴牙",
            wl: 22,
            src: "res/richedit/220958111.p.gif"
        }, {
            bgimg: "-194px -4px",
            title: "讨厌",
            wl: 22,
            src: "res/richedit/221004564.p.gif"
        }],
        fontsizedata: {
    ...
    initialize: function (container, data, b, options) {
        ...
        this.option.width = container.offsetWidth;
        this.option.height = container.offsetHeight;
        Css(this._body, {
        ...
        this.ed.open();
        var div = Sys.IE ? "<div>" + container.richeditText + "</div>" : container.richeditText;
    ...
    Expression: function (o) {
        ...
        if (!this.facebgpopup) {
            ...
            $$(expr.container, "div")[1].appendChild(createtab(1, this.option.facebg.length,
                        ...
                        function (i, j, td) {
                            Css(td, {
                                backgroundImage: "url(res/richedit/220510752.p.gif)",
    ...
    makebody: function (o, w, t, f, n) {
        if (!o) {
            ...
            this[n].pos();
            $$(this[n].container, "div")[1].innerHTML = "<div style=' margin-top:6px; margin-left:10px'><span >连接地址</span>　<input style='width:200px;' type='text' /></div><div style='text-align:center; padding-top:15px;'><img src='res/richedit/220836549.p.gif'>　<img src='res/richedit/220726721.p.gif'></div>"
...
function createRichedit(parent, text) {
    richeditInit();
    var data = [{
        Class: "span0",
        hover: "span0_hover",
    ...
    parent.richeditText = text;
    var result = new Editer(parent, data, LightBox.init());
    parent.richedit = result;
    return result;
} 